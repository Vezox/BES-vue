...
<template>
  <header id="header-main">
    <div class="header-main typography">
      ...
      <div class="container_common">
        <div class="content_common">
          ...
          <div class="menu-main">
            <ul id="js_menu" class="menu" color="#fff">
              <li
                id="menu-item-2779"
                  ...
                  >
                    ...
                    <ul class="sub-menu">
                      ...
                      <li
                        ...
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2786"
                      >
                        <a href="/hiep-hoi-doanh-nhan/">Hiệp hội doanh nhân</a>
                      </li>
                    </ul>
                  </li>
                </ul>
            ...
            <ul class="language">
              <li class="lang-item lang-item-3 lang-item-en lang-item-first">
                <a lang="en-US" hreflang="en-US" href="en/">en</a>
              </li>
              <li class="lang-item lang-item-6 lang-item-vi current-lang">
                <a lang="vi" hreflang="vi" href="vi/">vi</a>
              </li>
            </ul>
          </div>
          <div class="_folow">
    ...
    <div class="social-fix">
      <div class="list">
        <a href="/" class="social-item" id="enquiry-now-fix">
          <svg
            width="16"
            height="17"
            viewBox="0 0 16 17"
          ...
          >
            <g clip-path="url(#clip0_2147_47909)">
              <path
                d="M12.1732 2.78858C12.1732 2.4132 12.0267 2.05983 11.7612 1.79433L10.4355 0.468641C10.1737 0.206797 9.802 0.0566406 9.43213 0.0566406H9.35156V2.86914H12.1732L12.1732 2.78858Z"
                fill="#D71F27"
              />
              <path
                d="M8.56053 9.72967C8.65025 9.4573 8.80681 9.2037 9.01097 8.99817L12.1848 5.83714V3.80664H8.89103C8.63194 3.80664 8.4375 3.59698 8.4375 3.33789V0.0566406H1.40625C0.630813 0.0566406 0 0.687453 0 1.46289V14.6504C0 15.4258 0.630813 16.0566 1.40625 16.0566H10.766C11.5415 16.0566 12.1848 15.4258 12.1848 14.6504V11.1519L11.6697 11.6545C11.4609 11.8615 11.2165 12.012 10.9409 12.1041L9.45044 12.6017L9.22338 12.614C8.848 12.614 8.49278 12.4314 8.27216 12.1256C8.05334 11.8212 7.99384 11.4266 8.11284 11.07L8.56053 9.72967ZM2.34375 8.49414H7.01603C7.27513 8.49414 7.48478 8.7038 7.48478 8.96289C7.48478 9.22198 7.27513 9.43164 7.01603 9.43164H2.34375C2.08466 9.43164 1.875 9.22198 1.875 8.96289C1.875 8.7038 2.08466 8.49414 2.34375 8.49414ZM1.875 7.08789C1.875 6.8288 2.08466 6.61914 2.34375 6.61914H7.01603C7.27513 6.61914 7.48478 6.8288 7.48478 7.08789C7.48478 7.34698 7.27513 7.55664 7.01603 7.55664H2.34375C2.08466 7.55664 1.875 7.34698 1.875 7.08789ZM1.875 10.8379C1.875 10.5788 2.08466 10.3691 2.34375 10.3691H7.01603C7.27513 10.3691 7.48478 10.5788 7.48478 10.8379C7.48478 11.097 7.27513 11.3066 7.01603 11.3066H2.34375C2.08466 11.3066 1.875 11.097 1.875 10.8379ZM8.89103 13.1816C9.15013 13.1816 9.35978 13.3913 9.35978 13.6504C9.35978 13.9095 9.15016 14.1191 8.89103 14.1191H6.07853C5.81944 14.1191 5.60978 13.9095 5.60978 13.6504C5.60978 13.3913 5.81944 13.1816 6.07853 13.1816H8.89103ZM2.34375 5.68164C2.08466 5.68164 1.875 5.47198 1.875 5.21289C1.875 4.9538 2.08466 4.74414 2.34375 4.74414H8.89103C9.15013 4.74414 9.35978 4.9538 9.35978 5.21289C9.35978 5.47198 9.15013 5.68164 8.89103 5.68164H2.34375Z"
                fill="#D71F27"
              />
              <path
                d="M9.40854 10.1445L9.00073 11.368C8.9396 11.5513 9.11401 11.7256 9.29729 11.6644L10.52 11.256L9.40854 10.1445Z"
                fill="#D71F27"
              />
              <path
                d="M13.052 6.28516L9.96484 9.37231L11.2962 10.7037C11.994 10.0058 13.3517 8.648 14.3833 7.61641L13.052 6.28516Z"
                fill="#D71F27"
              />
              <path
                d="M15.7263 4.94016C15.5615 4.77444 15.3189 4.67969 15.0616 4.67969C14.8043 4.67969 14.5617 4.77444 14.396 4.94062L13.7148 5.62178L15.046 6.95297C15.4189 6.58003 15.6767 6.32228 15.7272 6.27175C16.0934 5.90503 16.0934 5.30772 15.7263 4.94016Z"
                fill="#D71F27"
              />
              <path
                d="M15.7266 6.27165C15.7266 6.27165 15.7266 6.27161 15.7266 6.27158C15.728 6.27024 15.7286 6.26964 15.7297 6.26855C15.7286 6.26968 15.728 6.27028 15.7266 6.27165Z"
                fill="#D71F27"
              />
              <path
                d="M15.7305 6.26877C15.7318 6.26746 15.7333 6.26593 15.7341 6.26514C15.7333 6.26596 15.7318 6.26746 15.7305 6.26877Z"
                fill="#D71F27"
              />
              <path
                d="M15.7344 6.26497C15.7374 6.26197 15.7374 6.26191 15.7344 6.26497V6.26497Z"
                fill="#D71F27"
              />
            </g>
            <defs>
        ...
        <a href="" class="social-item" id="visit-us-fix">
