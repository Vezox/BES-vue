  ...
  methods: {
    getHotNews30d() {
      ...
      api
        ...
        .then((res) => {
          this.hot_news_30d = res.data.list;
        })
        .catch((err) => {
          console.log(err);
        });
            ...
            <div class="container_common">
              <div class="content_common">
                <div class="wrap _flex_short">
                  <div class="_left" v-if="hot_news_30d.length">
                    <div class="new_feature" v-for="item in hot_news_30d">
                      <a
                ...
                <div class="inner_wrap js-tab-latest-news js_pagination_common">
                  ...
                  <div class="_tab_content tab_new_cat" data-content v-if="!loading">
                    <div class="new_feature" v-for="item in list_news">
                      <a
                        class="_img"
                        :href="localePath('/tin-tuc/' + item.slug)"
                      >
